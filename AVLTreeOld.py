...
class AVLNode(object):
    ...
    def __init__(self, key, value):
        ...
        self.right = EXT
        self.parent = None
        self.height = -1 if self.key is None else 0
...
"""A constant node used to represent external leaves."""
...
class AVLTree(object):
    ...
    def insert(self, key, value):
        ...
        node = parent.left if parent.left.key == key else parent.right
    ...
    and h is the number of PROMOTE cases during the AVL rebalancing
    """
    def insert_finger(self, key, value):
        if self.root is EXT:
        ...
        parent = current
        while parent is not EXT:
            if key < parent.key:
                if parent.left is EXT:
